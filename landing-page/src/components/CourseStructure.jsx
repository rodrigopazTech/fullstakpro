...
const CourseStructure = () => {
    ...
    return (
        <section id="temario" className="py-12 md:py-24 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12">
                    <div className="space-y-4 order-2 lg:order-1">
                        {modules.map((module) => (
                            <div key={module.id} className="block">
                                {/* Mobile Accordion Item Header / Desktop Tab Trigger */}
                                <motion.div
                                ...
                                {/* Mobile Only: Content expands below the active item */}
                                <AnimatePresence>
                    ...
                    {/* Desktop Only: Sticky Detail Panel */}
                ...
                {/* Calendar Note Added from Schedule */}
                <div className="mt-16 p-6 rounded-2xl bg-slate-900/50 border border-white/5 text-center">
                    <div className="inline-flex items-center gap-2 mb-2 text-primary-400 font-bold">
                        <span className="w-2 h-2 rounded-full bg-primary-500 animate-pulse"></span>
                        Inicio: Sábado 24 de Enero
                    </div>
                    <p className="text-slate-400 text-sm">
                        <strong>Masterclass de Bienvenida:</strong> 9:00 AM - 12:30 PM (CDMX) <br />
                        <strong>Clases Regulares:</strong> Sábados 9:00 AM - 10:00 AM
                    </p>
                </div>
            </div>
        </section >
